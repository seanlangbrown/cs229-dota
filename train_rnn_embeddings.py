...
import json
from train_ff import get_available_gpu, calc_accuracy, get_optimizer, should_stop_early, plotEpochStats, test_model
...
def train():
    ...
    if False: #Load and Test only
        test_model(model, test_data_loader, device, criterion, "./training/f_f_with_embeddings_14.model")
        return
